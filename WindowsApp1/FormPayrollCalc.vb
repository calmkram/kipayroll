Public Class PayrollCalc
    ...
    Private Sub GeneratePayroll_Click(sender As Object, e As EventArgs) Handles btnGeneratePayroll.Click
        ...
        Try
            ...
            If dtCurrentSelection.Date = dtPrevSelection.Date Then
                ...
                Debug.Print("Payroll for this month has just been generated - " & dtPayrollForMonth.ToString("MMM-yyyy") & "! Please exit this form or generate payroll for a different month.")
                Exit Sub
            End If
    ...
    Private Sub PayrollForMonth_TextChanged(sender As Object, e As EventArgs) Handles cmbPayrollForMonth.TextChanged
    ...
    Private Sub Save_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If Me.KIPayrollDataSet.SalaryCalculation.DefaultView.Count > 0 Then
                ...
                My.Application.Log.WriteEntry("Payroll calculations for " & dtPayrollForMonth.ToString("MMM-yyyy") & " already exist in the database! Select a different month for the payroll run.")
                Exit Sub
            Else
                For iEmpIndex = 0 To Me.KIPayrollDataSet.EmployeeMaster.DefaultView.Count - 1
                    ...
                    Catch ex As Exception
                        My.Application.Log.WriteException(ex, TraceEventType.Error, "Failed in SalaryCalculation Insert")
                        Exit Sub
                    End Try
                    ...
                    Try
                        ...
                        Next
                    Catch ex As Exception
                        My.Application.Log.WriteException(ex, TraceEventType.Error, "Failed in SalaryAdvances Update")
                        Exit Sub
                    End Try
                    ...
                    Try
                        ...
                        My.Application.Log.WriteEntry("Emp ID: " & sEmpMasterID & " has " & FormatCurrency(dOutstandingSalAdv) & " in Salary Advances outstanding!")
                    Catch ex As Exception
                        My.Application.Log.WriteException(ex, TraceEventType.Error, "Failed in EmployeeMaster Update")
                        Exit Sub
                    End Try
                Next
            End If
