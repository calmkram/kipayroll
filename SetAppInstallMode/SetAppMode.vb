...
Namespace MyDllModule
    Public Class SetAppMode
        ...
        Public Function SetMode(ByVal iInputValue As Integer, sAppPath As String) As Boolean
            Dim bReturnResult As Boolean = False, cAppConfig As System.Configuration.Configuration

            cAppConfig = ConfigurationManager.OpenExeConfiguration(sAppPath)
            ...
            For Each element As SettingElement In applicationSettingCol
                If element.Name = "AppMode" Then
                    ...
                    bReturnResult = True
                    Debug.Print("The new value for " & element.Name & " is " & iInputValue)
                End If
            Next
        ...
        Public Function GetMode(sAppPath As String) As Integer
